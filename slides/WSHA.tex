...
\title{Solving Geometry problems for Checking Reachability in Hybrid Systems}
...
\frame{
  \frametitle{Verification/Synthesis with Hybrid Automata}
  \begin{itemize}
  \item
...
\frame{
  \frametitle{Green Scheduling}
  \begin{itemize}
  	\item  Synthesizing controllers for maintaining temperatures of 2 rooms.
  	\item Minimizing peak energy usage
  \end{itemize}
  \begin{center}
...
\frame{
  \frametitle{Multi-mode Systems: Safe Schedulability}
  \begin{center}
    \scalebox{0.8}{
      \input{CoolEx3}
    }
    
   Safe set: $ T_1 \in [19, 24], T_2 \in [19, 24]$
  \end{center}
  
  \begin{tikzpicture}[node distance=1cm]
    
    \node[stloc, label=left:$\begin{matrix} x\\y\end{matrix}$,
    label=below:$s_0$] (s0) at (0,0) {$\begin{matrix} 22 \\ 22 \end{matrix}$};
    \pause
    \node[stloc, label=below:$s_1$] (s1) at (2,0) {$\begin{matrix} 21 \\ 21
      \end{matrix}$};  
    \draw[trans](s0) --node[midway,above]{$ (m_2, 1)$}  (s1);
    
    \pause
    \node[stloc, label=below:$s_2$] (s2) at (4,0) {$\begin{matrix} 20 \\ 24
      \end{matrix}$};  
    \draw[trans](s1) --node[midway,above]{$ (m_3, 1)$}  (s2);
    
    \pause
    \node[stloc, label=below:$s_3$] (s3) at (6,0) {$\begin{matrix} 22 \\ 22
      \end{matrix}$};  
    \draw[trans](s2) --node[midway,above]{$ (m_4, 1)$}  (s3);
    \pause
    \node[stloc, label=below:$s_4$] (s4) at (8,0) {$\begin{matrix} 21 \\ 21
      \end{matrix}$};  
    \draw[trans](s3) --node[midway,above]{$ (m_2, 1)$}  (s4);
...
\frame{
  \frametitle{Multi-mode Systems: Zeno schedule}
  \begin{center}
    \scalebox{0.8}{
      \input{CoolEx25}
    }
  ...
  \begin{tikzpicture}[node distance=1cm]
    ...
    \node[stloc, label=left:$\begin{matrix} x\\y\end{matrix}$,
    label=below:$s_0$] (s0) at (0,0) {$\begin{matrix} 22 \\ 22 \end{matrix}$};
    \node[stloc, label=below:$s_1$] (s1) at (2,0) {$\begin{matrix} 22 \\ 22
      \end{matrix}$};  
    \draw[trans](s0) --node[midway,above]{$ (m_2, 0)$}  (s1);
    
    \node[stloc, label=below:$s_2$] (s2) at (4,0) {$\begin{matrix} 22 \\ 22
      \end{matrix}$};  
    \draw[trans](s1) --node[midway,above]{$ (m_3, 0)$}  (s2);
    
    \node[stloc, label=below:$s_3$] (s3) at (6,0) {$\begin{matrix} 22 \\ 22
      \end{matrix}$};  
    \draw[trans](s2) --node[midway,above]{$ (m_4, 0)$}  (s3);
    \node[stloc, label=below:$s_4$] (s4) at (8,0) {$\begin{matrix} 22 \\ 22
      \end{matrix}$};  
    \draw[trans](s3) --node[midway,above]{$ (m_2, 0)$}  (s4);
    \draw[trans](s4) --node[midway,above]{$ \cdots$}  (10,0) ;
...
\frame{
  ...
  \begin{columns}
    ...
    \]    
    \column{2in}
    \only<1>{\input{energypeak}}
    \only<2>{\input{infpeak}}
  \end{columns}
}
