...
\frame{
  \frametitle{Concolic walk}
  \begin{block}{Concepts}
    \begin{itemize}
        \item Combination of symbolic reasoning, concrete evaluation and heuristic search 
        ...
        \item Search heuristic uses fitness function to guide random walk towards promising regions in valuation space
	\item Not complete, but sound approach to handle non-linear constraints in path condition
    \end{itemize}
  \end{block}
}
