...
\frame{
	...
	\begin{itemize}
		...
		\item $X$ is an (ordered) set of {\color{blue}variables},  \pause
...
\frame{
  ...
  \pause
    \begin{itemize}
        \item Given a timed path, checking for reachability is \blue{easy} \pause
        \begin{itemize}
            \item Get a \blue{simple} set of constraints \pause : Linear program \pause
...
\frametitle{Generating Relevant Paths}
    ...
    \vspace{0.1in}
    \begin{itemize}
        \item Every set of infeasible constraints (out of a path) gives some information \pause
        \begin{itemize}
...
\pause
    Summary \pause
    \begin{itemize}
        \item Constraint Optimization approach for solving reachability \pause
	...
	\begin{itemize}
        ...
        \item Heuristics for exploration of paths of same length
        ...
        \item Use of abstractions : \pause
            \begin{itemize}
                ...
                \item Efficiently calculate the ditness function \pause
            \end{itemize}
        \item Extend approach for attacking loops in programs
	\end{itemize}
}
